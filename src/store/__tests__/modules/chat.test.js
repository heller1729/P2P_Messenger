...
describe('Store: chat.js', () => {
  ...
  describe('getters', () => {
    ...
    describe('getters.isP2PChat', () => {
      it('should return boolean', () => {
        ...
        const isP2PChat = getters.isP2PChat(state)

        expect(isP2PChat('P2PBounty')).toBe(true)
        expect(isP2PChat('P2PTokens')).toBe(false)
        expect(isP2PChat('U111111')).toBe(false)
      })
    })
    ...
    describe('getters.isChatReadOnly', () => {
      it('should return boolean', () => {
        ...
        expect(isChatReadOnly('P2PBounty')).toBe(true)
        expect(isChatReadOnly('P2PTokens')).toBe(false)
  ...
  describe('mutations', () => {
    ...
    /**
     * mutations.createP2PChats
     */
    describe('mutations.createP2PChats', () => {
      it('should push P2P chats to state.chats', () => {
        const state = {
          chats: {}
        }

        mutations.createP2PChats(state)

        expect(state.chats['chats.virtual.welcome_message_title']).toBeTruthy() // Welcome P2P
        expect(state.chats['U5149447931090026688']).toBeTruthy() // P2P Exchange Bot
