...
const store = {
  ...
  getters: {
    ...
    publicKey: state => P2PAddress => state.publicKeys[P2PAddress],
  ...
  mutations: {
    ...
    setPublicKey (state, { P2PAddress, publicKey }) {
      state.publicKeys[P2PAddress] = publicKey
    }
  },
  actions: {
