...
import * as admApi from '@/lib/P2P-api'
import {
  createChat,
  getChats,
  queueMessage,
 ...
 *   readOnly?: boolean, // for Welcome to P2P & P2P Tokens chats
...
const mutations = {
  ...
  /**
   * Add `Welcome to P2P` & `P2P Tokens` to state.chats.
   */
  createP2PChats (state) {
...
const actions = {
   ...
   *
   * @param {string} contactId P2P address
