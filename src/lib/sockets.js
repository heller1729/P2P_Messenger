...
export class SocketClient extends EventEmitter {
  ...
  /**
   * @param address P2P address
   */
  init (address) {
    this.setP2PAddress(address)
  ...
  connect (node) {
    ...
    this.connection.on('connect', () => {
      ...
      console.log(`[Socket] Connected to ${node.socketAddress} and subscribed to transactions of ${this.P2PAddress}`)
      this.connection.emit('address', this.P2PAddress)
    })
