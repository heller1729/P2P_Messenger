...
import utils from './P2P'
import client from './P2P-api-client'
...
/**
 * Stores the supplied value into the P2P KVS under the specified key.
...
/**
 * Retrieves the stored value from the P2P KVS or array of KVS transactions
...
export function getChats (from = 0, offset = 0, orderBy = 'desc') {
  ...
  // https://github.com/P2P-im/P2P/wiki/API-Specification#get-chat-transactions
 ...
 *
 * @param {string} address P2P address
 * @param {any} params
 * @returns {Promise}
 */
 ...
 *
 * @param {string} address1 P2P address
 * @param {string} address2 P2P address
 * @param {any} params
 * @returns {Promise}
 */
