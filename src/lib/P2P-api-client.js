...
/**
 * Encapsulates an P2P node. Provides methods to send API-requests
...
class ApiNode {
  ...
  /**
   * Node hostname like bid.P2P.im or 23.226.231.225
   * @type {String}
   */
  get hostname () {
...
/**
 * Provides methods for calling the P2P API.
 *
 * The `ApiClient` instance automatically selects an P2P node to
